...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    target: 'col-resizer',
    title: 'まずは画面レイアウトを調整',
    body: 'マップとサイドバーの境界にあるこのハンドルを左右にドラッグすると、地図と操作パネルの幅を自由に変えられます。幅は自動で保存され、次回も維持されます。',
  },
  {
    target: 'section-resizer',
    title: 'セクションの高さも調整できます',
    body: '「地点リスト」や「計算履歴」など、リスト下端のこのグリップを上下にドラッグすると、その領域の高さを変えられます。長いリストを見やすい高さに収められます。',
  },
  {
    target: 'mode',
    title: '① 追加する地点の種別を選ぶ',
  ...
  },
  {
    target: 'breaks',
    title: '⑤ 休憩（ブレイク）',
    body: '車両に休憩を設定できます。「開始してよい時間帯」と「最低の休憩分数」を指定すると、最適化はその時間帯のどこかに休憩を挟んだルートを計算します。昼休憩と小休憩のように複数も設定できます。',
  },
  {
    target: 'vehicle-cost',
    title: '⑥ 最適化のコスト設定',
